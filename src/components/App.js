...
import {faBars, faTimes, faAngleRight, faAngleLeft} from '@fortawesome/free-solid-svg-icons';
import {faEdit, faTrashAlt, faSave} from '@fortawesome/free-regular-svg-icons';

library.add(faBars, faEdit, faTrashAlt, faSave, faTimes, faAngleRight, faAngleLeft);
